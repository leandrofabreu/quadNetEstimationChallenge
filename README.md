...
<p align="center">
  <img src="exp003_measured/expsetup003.jpg" alt="Ten green quadrature oscillator circuit boards connected by multicolored jumper wires in a small-world network layout, with six boards in the back row and four in the front row resting on a plain brown tabletop; white board text reads COUPLING on multiple modules, and the overall tone is technical and organized" width="250">
</p>
...
<p align="center">
  <img src="exp001_measured/expsetup001.jpg" alt="Two coupled quadrature oscillators" width="100">
</p>
...
$$
\begin{aligned}
\dot{v}_{\text{sen}} &= \left(\frac{1}{\tau_2}\right)v\_{\text{cos}} + \left(\frac{1}{\tau_1} - \frac{1}{\tau_2} + \frac{1}{C_1R_a} \right)v_1 + u_1, \\
\dot{v}\_{\text{cos}} &= \left(-\frac{1}{\tau_3}\right)v\_{\text{sen}} - \frac{1}{C_3}I_l + u_2, \\
\dot{v}\_{1} &= \left(\frac{1}{\tau_2}\right)v\_{\text{cos}} - \frac{1}{\tau_2}v_1,
\end{aligned}
$$
...
I_l =
\begin{cases} 
\frac{1}{R_5}v_{\text{cos}} + \frac{V_{cc}}{R_4}, & \text{if } v_{\text{cos}} < -\frac{R_5}{R_4}V_{cc} - \left(1 + \frac{R_5}{R_4}\right)V_{d}, \\
\frac{1}{R_5}v_{\text{cos}} - \frac{V_{cc}}{R_4}, & \text{if } v_{\text{cos}} > \frac{R_5}{R_4}V_{cc} + \left(1 + \frac{R_5}{R_4}\right)V_{d}, \\
0, & \text{otherwise},
\end{cases}
$$
